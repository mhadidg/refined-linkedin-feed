 ...
 *
 * Content scripts can't directly use WebExtension storage APIs, they
 * must communicate with the extension's background scripts, to
 * indirectly access all the same APIs that the background scripts can.
 *
